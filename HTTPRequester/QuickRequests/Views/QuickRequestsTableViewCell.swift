//
//  QuickRequestsTableViewCell.swift
//  HTTPRequester
//
//  Created by Степан Соловьёв on 07.11.2022.
//

import UIKit

final class QuickRequestsTableViewCell: UITableViewCell, IdentifiableProtocol {
    ...
    private let subtitleForCell: UILabel = {
        ...
        subtitle.text = "https://vk.com/audios118051043?section=general"
        subtitle.numberOfLines = 3
        return subtitle
    }()
    
    private let imageForCell: UIImageView = {
        let image = UIImageView(image: UIImage(systemName: "terminal.fill"))
    ...
    private func configureContainerForView(container view: UIView) {
        ...
        NSLayoutConstraint.activate([
            ...
            subtitleForCell.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -32)
...
//    func setDataInQuickRequestCell(title: String, countRequests subtitle: Int) {
